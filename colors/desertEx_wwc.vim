...
let g:colors_name="desertEx_wwc"

highlight Normal guifg=DarkGreen  guibg=LightGreen gui=NONE ctermfg=250 ctermbg=235 cterm=NONE


" highlight groups
highlight Cursor        guifg=black				guibg=yellow gui=NONE ctermfg=16 ctermbg=226 cterm=NONE
highlight CursorLine    guifg=NONE			guibg=grey gui=NONE ctermfg=16 ctermbg=226 cterm=NONE
...
highlight NonText       guifg=DarkGreen  guibg=LightGreen gui=NONE ctermfg=250 ctermbg=235 cterm=NONE
...
highlight Comment       guifg=LightBlue  gui=NONE ctermfg=114 cterm=NONE
