...
hi MarkWord6   ctermbg=101      ctermfg=Black  guibg=#9999FF    guifg=Black
hi MarkWord7   ctermbg=186      ctermfg=Black  guibg=#9999FF    guifg=Black
hi MarkWord8   ctermbg=217      ctermfg=Black  guibg=#9999FF    guifg=Black
hi MarkWord9   ctermbg=230      ctermfg=Black  guibg=#9999FF    guifg=Black
hi MarkWord10  ctermbg=215      ctermfg=Black  guibg=#9999FF    guifg=Black
hi MarkWord11  ctermbg=102      ctermfg=Black  guibg=#9999FF    guifg=Black
hi MarkWord12  ctermbg=123      ctermfg=Black  guibg=#9999FF    guifg=Black
...
function! s:InitMarkVariables()
	if !exists("g:mwHistAdd")
		let g:mwHistAdd = "/@"
		"-- wwc 2013年 03月 08日 星期五 22:47:11 GMT-8
		" default colors/groups
		" you may define your own colors in you vimrc file, in the form as below:
		hi MarkWord1   ctermbg=Cyan     ctermfg=Black  guibg=#8CCBEA    guifg=Black
		hi MarkWord2   ctermbg=Green    ctermfg=Black  guibg=#A4E57E    guifg=Black
